    ...
    <div className="flex flex-col md:flex-row min-h-screen">
      <main className="flex-1 p-8 md:p-12 border-r border-gray-100">
        <article>
          ...
          <div className="prose prose-lg max-w-none font-serif" dangerouslySetInnerHTML={{ __html: post.content }} />
        </article>
        <div className="mt-12 pt-6 border-t border-gray-100">
          <Link href="/" className="text-gray-600 hover:text-gray-900 font-serif">
            ← Back to all posts
          </Link>
        </div>
      </main>
